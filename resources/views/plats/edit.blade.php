                ...
                <form method="POST" action="{{ route('plats.update', $plat->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="shadow overflow-hidden sm:rounded-md">
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <textarea name="description_menu" id="description_menu" class="form-input rounded-md shadow-sm mt-1 block w-full" cols="30" rows="6">{{ $plat->description_menu }}</textarea>
