            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ URL('/') }}">
                        ...
                        <img src="{{ asset('images/logo.png') }}" alt="LOGO" style="width: 53px; mix-blend-mode: hard-light;">
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('plats.index') }}" :active="request()->routeIs('plats.index')">
                        {{ __('Plats') }}
                    </x-jet-nav-link>
                </div>
            </div>
